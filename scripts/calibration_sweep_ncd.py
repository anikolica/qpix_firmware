# Program to run QPIX Calibration Sweep -ncd 10/2/2024
...
os.system('python3 Serial_Interface.py  1  0x95B6FF44')
s.sample_cal(numTrials, 18)

# DECIMAL 17
print("Running DECIMAL_replen: 17")
os.system('python3 Serial_Interface.py  1  0x15B6FFC4')
s.sample_cal(numTrials, 17)

# DECIMAL 16
print("Running DECIMAL_replen: 16")
os.system('python3 Serial_Interface.py  1  0x15B6FF44')
