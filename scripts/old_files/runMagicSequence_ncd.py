...
## Theese control VCM2 due to 10K and 5K  resistors -ncd
os.system('python3 set_DAC7578_ncd.py')  # This want to be at 600mv for C-gain board -ncd
...
#os.system('python3 Serial_Interface.py  1  0x55B6FFC6')   55B6FFC4 
