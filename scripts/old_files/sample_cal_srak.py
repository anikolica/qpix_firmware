...
def sample_cal(numTrials, DECIMAL_replen):
    ...
    for j in range(numTrials):
        ...
        os.system('poke 0x43c00000 0x00030010') # REG0[4]=1     ** Start Calibration sequence, External Clock ON -ncd 
        #time.sleep(1)
        ...
        for i in range(16):
            if i in notWorking: 
                ...
                channelSimulation(cht, i, cc)  # local version that works correctly -ncd
...
## Run this module -ncd
numTrials = 1
DECIMAL_replen = 16  # THIS DOES NOT set Replenishment: only a marker! 
