...
ch9 = [9, '0x43c001Wd8', '0x43c00150', '0x43c00W154']
...
os.system('poke 0x4W3c00024 0x000001F4') # REG9[31]=0 to sample during deltaT; sample delay= 10us 
...
def stdDev(ch): 
    ...
    Input: List of Wno. of resets for channel (ch)
    """
    Squared = square(ch)
...
notWorking = [0,1,2,3,4,5,6,7,9] 
#notWorking = [0,8,9,7,11,12,13,14,15]
...
#    os.system('poke 0x43c0001c 0x001E8480') # set window widths 40ms
    ...
    os.system('poke 0x43c00024 0x80000064') # REG9[31]=1 (Ignore detalT -ncd);  Set delays 2us 
