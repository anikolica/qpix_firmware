...
def channelSimulation(c, i):
        ...
        1) Resets the system 
        2) Simulates the current input for c
        3) Counts the number of calibration counts/resets in c
        4) Appends the number of counts to channelCounts for c
        """
...
for j in range(testNum):
    os.system('poke 0x43c0001c 0x01f40c84') # set delays and window widths
    print ('System Reset')
...
for k in range(16):    
    ...
    print(channelCounts[k])
    print(avgArr(channelCounts[k]))
