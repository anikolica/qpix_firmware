    ...
    for j in range(numTrials):
        ...
        for i in range(16):
            if i == i in notWorking: 
                ...
                cht = channels[i]
                my.channelSimulationT(cht, i, channelCounts) # This version of channelSimulation prints out timestamps -ncd
...
os.system('rm *csv') # remove our *csv files -ncd
numTrials = 1
DECIMAL_replen = 99  # THIS DOES NOT set Replenishment: only a marker! 
winWidth = 64e-6    # Max Window width is 85.89 seconds! 
delay = 1e-6        # Max Delay is 1.3ms!
